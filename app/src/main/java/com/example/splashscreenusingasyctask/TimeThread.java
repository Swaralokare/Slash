...
package com.example.splashscreenusingasyctask;
...
import com.example.splashscreenusingasyctask.SplashActivity;
...
public class TimeThread extends AsyncTask<Integer,Integer,Integer> {
    ...
    public TimeThread(Context context ,Handler handler,ProgressBar progressBar)
    {
